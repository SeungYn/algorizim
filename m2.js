...
baseURI
: 
"http://127.0.0.1:5501/ch1/origin.html"
childElementCount
: 
1
childNodes
: 
NodeList(2) [text, button.delete-button]
children
: 
HTMLCollection [button.delete-button]
classList
: 
DOMTokenList [value: '']
className
...
innerHTML
: 
"f<button class=\"delete-button\">Delete</button>"
innerText
: 
"fDelete"
inputMode
...
outerHTML
: 
"<li>f<button class=\"delete-button\">Delete</button></li>"
outerText
: 
"fDelete"
ownerDocument
...
getAttributeNodeNS
: 
ƒ getAttributeNodeNS()
getBoundingClientRect
: 
ƒ getBoundingClientRect()
getClientRects
: 
ƒ getClientRects()
...
: 
ƒ insertAdjacentElement()
insertAdjacentHTML
: 
ƒ insertAdjacentHTML()
insertAdjacentText
: 
ƒ insertAdjacentText()
lastElementChild
: 
(...)
localName
...
: 
ƒ webkitMatchesSelector()
webkitRequestFullScreen
: 
ƒ webkitRequestFullScreen()
webkitRequestFullscreen
: 
ƒ webkitRequestFullscreen()
constructor
...
: 
ƒ ariaAutoComplete()
set ariaAutoComplete
: 
ƒ ariaAutoComplete()
get ariaBrailleLabel
: 
ƒ ariaBrailleLabel()
set ariaBrailleLabel
: 
ƒ ariaBrailleLabel()
get ariaBrailleRoleDescription
: 
ƒ ariaBrailleRoleDescription()
set ariaBrailleRoleDescription
: 
ƒ ariaBrailleRoleDescription()
get ariaBusy
: 
