...
while (true) {
  ...
  if (result === 1) console.log(`Case ${testCase}: There is one tree.`);
  else if (result === 0) console.log(`Case ${testCase}: No trees.`);
  else console.log(`Case ${testCase}: A forest of ${result} trees.`);
